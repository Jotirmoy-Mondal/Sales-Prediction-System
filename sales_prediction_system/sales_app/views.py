    ...
    if request.method == 'POST':
        try:
            ...
            if tv < 0 or radio < 0 or newspaper < 0:
                ...
                model = load_model()
                if model is None:
                    # Fallback: use approximate linear regression coefficients
                    # Based on the Advertising dataset typical results:
                ...
                context['form_data'] = {'tv': tv, 'radio': radio, 'newspaper': newspaper}
